...
<form action="/add_to_cart" method="post">
      ...
      <div class="row">
      <div class="col"></div>
      <div class="col-8"> <div class="card mb-3" style="max-width:540px;">
  <div class="row g-0">
    <div class="col-md-4">
 <img height="200px" width="200px" src="{{ URL ::asset('assets/project_img/'.$prods->pimage) }}" class="card-img-top" alt="...">    </div>
    <div class="col-md-8">
      <div class="card-body">
      <h4 class="card-title">{{$prods->pname}}</h4>
        <h5 class="card-title">Rs{{$prods->price}}</h5>
        <p class="card-text">{{$prods->pdis}}</p>
  ...
  <div class="col"></div>
         ...
         <br><br>
         <center> <a href="/pv" class="btn btn-primary">Back To View</a></center>
