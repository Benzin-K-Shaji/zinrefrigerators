...
<body background="">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="row row-cols-1 row-cols-md-3 lg-4">
          ...
          <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <p class="card-text"> From ₹4707.34/mo for 24 mos at 12% Interest or ₹ 100000.00<br>
                ...
                <a href="/l" class="btn btn-primary">Buy now</a>
            </div>
          </div>
        </div>
        <div class="col col-12 col-sm-3 col-md-3 col-lg-3">
        ...
        <div class="col col-12 col-sm-3 col-md-3 col-lg-3">
          ...
          <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              <h5 class="card-title">RF60J9090SL French DoorTechnology 693L</h5>
      ...
      <div class="card text-center">
        ...
        <div class="card-body">
          <a href="/l" class="btn btn-primary">View More</a>
        </div>
...
<br>
      ...
      <table class="table table-borderless">
        ...
        <tr><td><a class="navbar-brand" href="/cc">Contact us</a></td></tr>
        
        <tr><td><a class="navbar-brand" href="/cg">Gallery</a></td></tr>
        <tr><td><a class="navbar-brand" href="/reg">signup</a></td></tr>
