...
<form action="/destroy/{{$user->id}}" method="post" enctype="multipart/form-data">
@csrf
    <h2 style="font-family:verdana;color:rgb(251, 255, 251);"><center>PRODUCT DELETE</center></h2>
 <table class="table table-borderless" style="font-family:verdana;color:rgb(251, 255, 251);">
    ...
    <tr>
     ...
     <tr>
         ...
         <td><button type="submit" class="btn btn-success">Delete</button> &nbsp; &nbsp;<a href="/userview" class="btn btn-outline">&#x1F519;</a></td>
